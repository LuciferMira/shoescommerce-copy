            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Tabel Ukuran</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Dashboard</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Ukuran</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myLargeModalLabel">Tambah Ukuran</h4>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="post" action="<?= base_url('admin/ukuran/add') ?>">
                                ...
                                <br>
                                    <table class="table">
                                        ...
                                        <tbody>
                                          <?php $no = 1; foreach($ukuran as $row) :?>
                                            <tr>
                                                <td><?= $no++ ?></td>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admin/ukuran/edit/'.$row->id_ukuran) ?>" class="btn waves-effect waves-light btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                                    <a href="<?= base_url('admin/ukuran/detail/'.$row->id_ukuran) ?>" class="btn waves-effect waves-light btn-primary"><i class="fas fa-th-list"></i></a>
                                                    <a onclick="deleteConfirm('<?= base_url('admin/ukuran/delete/'.$row->id_ukuran) ?>')" href="#"

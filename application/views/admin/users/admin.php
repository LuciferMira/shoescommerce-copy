            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Tabel Admin</h3>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="<?= base_url('admin/users/add_admin') ?>" enctype="multipart/form-data">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="tempat_lahir">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <textarea class="form-control" id="floatingTextarea2" style="height: 200px" name="alamat"></textarea>
                                                    </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="exampleInputPassword1" class="form-label">Foto</label>
                                                        <input type="file" class="form-control" id="exampleInputPassword1" name="foto" multiple="">
                                                    </div>
                                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                          <?php $no = 1; foreach($users as $row) :
                                            if($row->nama == $datauser['nama']){ continue; }?>
                                            <tr>
                                                <td><?= $no++ ?></td>
                                                <td><?= $row->nama ?></td>
                                                <td><?= $row->email ?></td>

...
class Login extends CI_Controller {
	...
	public function index()
	{
		include_once APPPATH . "../vendor/autoload.php";
		  ...
		  $google_client->setClientId('388926786174-fpl6m4cssf1lmj4i3r5rfsivbb841t6k.apps.googleusercontent.com'); //masukkan ClientID anda
		  $google_client->setClientSecret('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'); //masukkan Client Secret Key anda
		  $google_client->setRedirectUri('http://shoescommerce.42web.io/login'); //Masukkan Redirect Uri anda
